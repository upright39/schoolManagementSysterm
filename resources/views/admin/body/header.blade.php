   ...
   <nav class="navbar navbar-static-top pl-30">
    ...
    <div class="navbar-custom-menu r-side">
     <ul class="nav navbar-nav">
      ...
      <!-- CODE TO HELP THE IMAGE APPEAR IN ALL PAGES -->
      @php
      $user= DB::table('users')->where('id',Auth::user()->id)->first();
      @endphp
      <!-- END CODE TO HELP THE IMAGE APPEAR IN ALL PAGES -->
      <!-- User Account-->
      <li class="dropdown user user-menu">
       ...
       <ul class="dropdown-menu animated flipInX">
        <li class="user-body">
         ...
         <a class="dropdown-item" href="{{route('logout_user')}}"><i class="ti-lock text-muted mr-2"></i> Logout</a>
        </li>
       </ul>
      </li>
      <li>
