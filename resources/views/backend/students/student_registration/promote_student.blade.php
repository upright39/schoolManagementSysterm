    ...
    <section class="content">
     ...
     <div class="box">
      ...
      <div class="box-body">
       <div class="row">
        <div class="col">
         <form method="post" action="{{route('store_promotion',$AssignSub->student_id)}}" enctype="multipart/form-data">
          @csrf
          ...
          <div class=" row">
           ...
           <div class="col-4">
            <div class="form-group">
             <h5>Add Promoted Year <span class="text-danger">*</span></h5>
             <div class="controls">
           ...
           <div class="col-4">
            <div class="form-group">
             <h5>Promote Class <span class="text-danger">*</span></h5>
             <div class="controls">
